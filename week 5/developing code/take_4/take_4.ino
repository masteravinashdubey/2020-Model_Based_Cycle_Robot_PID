...
TCCR1A = B00001101;  //setting up prescaler to 1024 and ctc mode too
...
OCR1BL = 0x19;       //low byte of compare match register//interrupt after 18ms

OCR1CH = 0x00;       //high byte of compare match register
OCR1CL = 0xF9;       //low byte of compare match register//intrrupt after 16ms
