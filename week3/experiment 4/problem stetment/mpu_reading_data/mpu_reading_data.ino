...
void loop() {
 ...
 //-----------------------------------------------------------------
float fused_data = fuse_data(degree_gyro, degree_accl); // calling function to run data fusion algorythem
//-----------------------------------------------------------------
 ...
 Serial.println(fused_data);
 delay (5);
}


float fuse_data(float deg_gyro, float deg_accl){
//-----------------------------------------------------------------
// write your algorythem to get accurate data from both the sensor here
//and return it in pitch 
//here passed argument 'deg_gyro' and 'deg_accl' are angle derived from respective sensor indevidually
//-----------------------------------------------------------------
